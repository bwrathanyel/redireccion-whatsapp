...
const ACTUALIZACIONES_LOG = [
  { fecha: '2026-08-03', emoji: '🧑‍💼', titulo: 'Consultor IA', texto: 'Sección nueva para preguntarle a una IA (DeepSeek) sobre el proyecto: arquitectura, decisiones tomadas, qué falta. Responde con la documentación real del CRM y, si no sabe algo, lo dice en vez de inventarlo. Es de solo consulta -- no edita código ni ejecuta nada.', roles: ['admin'] },
